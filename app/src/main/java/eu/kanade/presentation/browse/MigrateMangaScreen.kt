...
internal fun LazyListScope.migrateMangaItems(
    selectionMode: Boolean,
    manga: List<MigrationMangaScreenItem>,
    onClickItem: (MigrationMangaScreenItem) -> Unit,
    onClickCover: (MigrationMangaScreenItem) -> Unit,
    onMangaSelected: (MigrationMangaScreenItem, Boolean, Boolean, Boolean) -> Unit,
) {
    items(
        ...
        MigrateMangaScreenUiItem(
            ...
            onClick = {
                when {
                    selectionMode -> onMangaSelected(it, !it.selected, true, false)
                    else -> onClickItem(it)
                }
            },
            onLongClick = { onMangaSelected(it, !it.selected, true, true) },
            onClickCover = { onClickCover(it) }.takeIf { !selectionMode },
        )
    }
}
