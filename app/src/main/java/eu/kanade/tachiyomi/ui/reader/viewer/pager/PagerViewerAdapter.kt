...
class PagerViewerAdapter(private val viewer: PagerViewer) : ViewPagerAdapter() {
    ...
    // TX-->
    /**
     * Paired list of currently set items. (SY)
     */
    var joinedItems: MutableList<Pair<Any, Any?>> = mutableListOf()
        private set

    /**
     * Single list of items (SY)
     */
    ...
    fun setChapters(chapters: ViewerChapters, forceTransition: Boolean) {
        ...
        // Show transition page if chapters missing between previous chapter and current chapter
        // or forceTransition = true or previous chapter is not loaded yet
        ...
        nextTransition = ChapterTransition.Next(chapters.currChapter, chapters.nextChapter)
            .also {
                // Show transition page if chapters missing between next chapter and current chapter
                // or forceTransition = true or next chapter is not loaded yet
            ...
            pagedItems.forEach { items ->
                ...
                if (viewer.config.shiftDoublePage) {
                    run loop@{
                        ...
                        // Add a shifted page to the first place there isn't a full page
