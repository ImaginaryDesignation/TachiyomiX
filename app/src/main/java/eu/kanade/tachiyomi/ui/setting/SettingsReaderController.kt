...
import eu.kanade.tachiyomi.ui.reader.setting.ReaderBottomButtonController
    ...
    override fun setupPreferenceScreen(screen: PreferenceScreen) = screen.apply {
        ...
        preferenceCategory {
            ...
            preference {
                ...
                onClick {
                    router.pushController(ReaderBottomButtonController().withFadeTransaction())
                }
            }
            intListPreference {
            ...
            switchPreference {
                bindTo(preferences.hideReaderMenuOnScroll())
                titleRes = R.string.pref_hide_reader_menu
            }
            switchPreference {
                bindTo(preferences.useAnimatedLoader())
                titleRes = R.string.animated_loader
                summaryRes = R.string.animated_loader_summary
            }
        }
        // TX<--
    }
