    ...
    override fun onViewCreated(view: View) {
        ...
        val simpleItemTouchCallback: ItemTouchHelper.SimpleCallback = object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                val item = adapter?.getItem(pos) as? HistoryItem ?: return
                adapter?.notifyItemChanged(pos)
                when (direction) {
                    ItemTouchHelper.LEFT -> onRemoveClick(pos)
                    ItemTouchHelper.RIGHT -> onRemoveClick(pos)
                }
            }
            ...
            override fun onChildDraw(
                ...
                val pos = viewHolder.absoluteAdapterPosition
                val item = adapter?.getItem(pos) as? HistoryItem
                if (item == null) {
                    super.onChildDraw(
                        c,
                        recyclerView,
                    ...
                    builder.addSwipeLeftBackgroundColor(Color.parseColor("#C60629"))
                    builder.addSwipeRightBackgroundColor(Color.parseColor("#C60629"))
                    builder.addSwipeLeftActionIcon(R.drawable.ic_delete_24dp)
                    builder.addSwipeRightActionIcon(R.drawable.ic_delete_24dp)
                    builder.create()
                        .decorate()
                    super.onChildDraw(
                        c,
