    ...
    init {
        coroutineScope.launch {
            ...
            getFavorites.subscribe(sourceId)
                ...
                .map { manga ->
                    manga.sortedWith(compareBy(String.CASE_INSENSITIVE_ORDER) { it.manga.title })
                }
                .collectLatest { list ->
...
data class MigrateMangaState(
    ...
    private val titleList: List<MigrationMangaScreenItem>? = null,
) {
